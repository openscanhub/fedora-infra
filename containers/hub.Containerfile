...
# TODO: REMOVE `packit/openscanhub-openscanhub-234` BEFORE MERGING
...
RUN dnf install -y resalloc-agent-spawner python3-resalloc osh-worker-manager
...
# TODO: COMMENT THESE LINES BEFORE MERGING.
