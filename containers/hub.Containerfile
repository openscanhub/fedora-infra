...
# `centpkg` is required for `/etc/koji.conf.d/stream.conf`
RUN dnf install -y osh-hub osh-hub-conf-devel openssl krb5-workstation tzdata fedora-messaging centpkg
